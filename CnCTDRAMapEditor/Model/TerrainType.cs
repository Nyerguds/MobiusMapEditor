...
namespace MobiusEditor.Model
{
    public class TerrainType : ITechnoType, ICellOverlapper, ICellOccupier
    {
        ...
        public string[] Theaters { get; private set; }
        ...
        public TerrainType(int id, string name, string textId, string[] theaters, int width, int height, Point centerPoint, string occupyMask, String graphicsSource, int displayIcon, LandType placementLand)
        {
            this.ID = id;
            this.Name = name;
            this.nameId = textId;
        ...
        /// <param name="graphicsSource">Override for the graphics source. If null, the name is used.</param>
        /// <param name="displayIcon">Override for the frame to display. Normally 0.</param>
        public TerrainType(int id, string name, string textId, string[] theaters, int width, int height, Point centerPoint, string occupyMask, String graphicsSource, int displayIcon)
        ...
        /// <param name="occupyMask">String indicating the occupied cells. Spaces are ignored, '0' means unoccupied, any other value means occupied. A null value indicates it is fully occupied.</param>
        /// <param name="graphicsSource">Override for the graphics source. If null, the name is used.</param>
        public TerrainType(int id, string name, string textId, string[] theaters, int width, int height, Point centerPoint, string occupyMask, String graphicsSource)
        ...
        /// <param name="occupyMask">String indicating the occupied cells. Spaces are ignored, '0' means unoccupied, any other value means occupied. A null value indicates it is fully occupied.</param>
        /// <param name="displayIcon">Override for the frame to display. Normally 0.</param>
        public TerrainType(int id, string name, string textId, string[] theaters, int width, int height, Point centerPoint, string occupyMask, int displayIcon)
        ...
        /// <param name="occupyMask">String indicating the occupied cells. Spaces are ignored, '0' means unoccupied, any other value means occupied. A null value indicates it is fully occupied.</param>
        /// <param name="placementLand">Land type this should be placed down on. Currently unused.</param>
        public TerrainType(int id, string name, string textId, string[] theaters, int width, int height, Point centerPoint, string occupyMask, LandType placementLand)
        ...
        /// <param name="height">Height of the terrain object, in cells.</param>
        /// <param name="occupyMask">String indicating the occupied cells. Spaces are ignored, '0' means unoccupied, any other value means occupied. A null value indicates it is fully occupied.</param>
        public TerrainType(int id, string name, string textId, string[] theaters, int width, int height, Point centerPoint, string occupyMask)
