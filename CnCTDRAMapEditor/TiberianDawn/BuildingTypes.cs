...
namespace MobiusEditor.TiberianDawn
{
    public static class BuildingTypes
    {
        ...
        public static readonly BuildingType Refinery = new BuildingType(7, "proc", "TEXT_STRUCTURE_TITLE_GDI_REFINERY", 10, 40, new bool[3, 3] { { false, true, false }, { true, true, true }, { false, false, false } }, "Goodguy", BuildingTypeFlag.Bib);
        public static readonly BuildingType Storage = new BuildingType(8, "silo", "TEXT_STRUCTURE_TITLE_GDI_SILO", 0, 10, new bool[1, 2] { { true, true } }, "Goodguy", BuildingTypeFlag.Bib);
        ...
        public static readonly BuildingType Hospital = new BuildingType(14, "hosp", "TEXT_UNIT_TITLE_HOSP", 0, 20, new bool[2, 2] { { true, true }, { true, true } }, "Goodguy", BuildingTypeFlag.Bib);
        ...
        public static readonly BuildingType BioLab = new BuildingType(18, "bio", "TEXT_UNIT_TITLE_BIO", 0, 40, new bool[2, 2] { { true, true }, { true, true } }, "Goodguy", BuildingTypeFlag.Bib);
