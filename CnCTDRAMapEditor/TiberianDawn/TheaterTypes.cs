...
namespace MobiusEditor.TiberianDawn
{
    public static class TheaterTypes
    {
        ...
        public static readonly TheaterType Winter = new TheaterType(2, "Winter", "winter", "win", "TD_Terrain_Winter".Yield().Concat(commonTilesets).Concat("TD_Terrain_Temperate".Yield()));
