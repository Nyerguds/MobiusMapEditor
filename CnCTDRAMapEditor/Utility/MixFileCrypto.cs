// Class written by https://github.com/MortonPL
// with minor adjustments to make it work on .Net 4.6.2
//
using System;
using System.IO;
...
namespace MobiusEditor.Utility
{
    ...
    public class BlowfishStream : Stream
    {
        ...
        private void DecryptBlock(byte[] destination, byte[] source, int offset)
        {
            ...
            // To big endian.
            temp[0] = ReverseEndianness(temp[0]);
            temp[1] = ReverseEndianness(temp[1]);
