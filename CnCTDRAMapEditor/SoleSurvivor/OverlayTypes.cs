...
namespace MobiusEditor.SoleSurvivor
{
    public static class OverlayTypes
    {
        ...
        public static readonly OverlayType Teleport = new OverlayType(18, "road", "TEXT_OVERLAY_TELEPORTER", null, OverlayTypeFlag.Pavement, 1);
        ...
        public static readonly OverlayType V16 = new OverlayType(25, "v16", "TEXT_STRUCTURE_TITLE_CIV15", new[] { TiberianDawn.TheaterTypes.Temperate, TiberianDawn.TheaterTypes.Winter }, OverlayTypeFlag.Solid);
        public static readonly OverlayType V17 = new OverlayType(26, "v17", "TEXT_STRUCTURE_TITLE_CIV16", new[] { TiberianDawn.TheaterTypes.Temperate, TiberianDawn.TheaterTypes.Winter }, OverlayTypeFlag.Solid);
        public static readonly OverlayType V18 = new OverlayType(27, "v18", "TEXT_STRUCTURE_TITLE_CIV17", new[] { TiberianDawn.TheaterTypes.Temperate, TiberianDawn.TheaterTypes.Winter }, OverlayTypeFlag.Solid);
