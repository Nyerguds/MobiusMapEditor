    ...
    public class OverlaysTool : ViewTool
    {
        ...
        protected override void RefreshPreviewPanel()
        {
            ...
            if (SelectedOverlayType != null)
            {
                ...
                var render = MapRenderer.RenderOverlay(plugin.GameType, map.Theater, new OverlayType[0], new OverlayType[0], new Point(0,0), Globals.PreviewTileSize, Globals.PreviewTileScale, mockOverlay);
