...
namespace MobiusEditor.RedAlert
{
    public static class UnitTypes
    {
        ...
        public static readonly UnitType MRJammer = new UnitType(9, "mrj", "TEXT_UNIT_RA_MRJ", "Greece", 0, -5, UnitTypeFlag.HasTurret);
        public static readonly UnitType MGG = new UnitType(10, "mgg", "TEXT_UNIT_RA_MGG", "Greece", Int32.MaxValue, 0, UnitTypeFlag.HasTurret);
