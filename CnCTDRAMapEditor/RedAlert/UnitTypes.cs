...
namespace MobiusEditor.RedAlert
{
    public static class UnitTypes
    {
        ...
        public static readonly UnitType Heli = new UnitType(5 | UnitTypeIDMask.Aircraft, "heli", "TEXT_UNIT_RA_HELI", "Greece", UnitTypeFlag.IsArmed);
        public static readonly UnitType Hind = new UnitType(6 | UnitTypeIDMask.Aircraft, "hind", "TEXT_UNIT_RA_HIND", "USSR", UnitTypeFlag.IsArmed);
        ...
        public static readonly UnitType Destroyer = new UnitType(1 | UnitTypeIDMask.Vessel, "dd", "TEXT_UNIT_RA_DD", "Greece", UnitTypeFlag.IsArmed | UnitTypeFlag.HasTurret);
        public static readonly UnitType Cruiser = new UnitType(2 | UnitTypeIDMask.Vessel, "ca", "TEXT_UNIT_RA_CA", "Greece", UnitTypeFlag.IsArmed | UnitTypeFlag.HasTurret);
        public static readonly UnitType Transport = new UnitType(3 | UnitTypeIDMask.Vessel, "lst", "TEXT_UNIT_RA_LST", "Greece");
        public static readonly UnitType PTBoat = new UnitType(4 | UnitTypeIDMask.Vessel, "pt", "TEXT_UNIT_RA_PT", "Greece", UnitTypeFlag.IsArmed | UnitTypeFlag.HasTurret);
