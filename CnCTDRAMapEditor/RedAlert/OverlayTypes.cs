...
namespace MobiusEditor.RedAlert
{
    public static class OverlayTypes
    {
        ...
        public static readonly OverlayType Gold1 = new OverlayType(5, "gold01", "Gold", OverlayTypeFlag.TiberiumOrGold);
        public static readonly OverlayType Gold2 = new OverlayType(6, "gold02", "Gold", OverlayTypeFlag.TiberiumOrGold);
        public static readonly OverlayType Gold3 = new OverlayType(7, "gold03", "Gold", OverlayTypeFlag.TiberiumOrGold);
        public static readonly OverlayType Gold4 = new OverlayType(8, "gold04", "Gold", OverlayTypeFlag.TiberiumOrGold);
        public static readonly OverlayType Gems1 = new OverlayType(9, "gem01", "Gems", OverlayTypeFlag.Gems);
        public static readonly OverlayType Gems2 = new OverlayType(10, "gem02", "Gems", OverlayTypeFlag.Gems);
        public static readonly OverlayType Gems3 = new OverlayType(11, "gem03", "Gems", OverlayTypeFlag.Gems);
        public static readonly OverlayType Gems4 = new OverlayType(12, "gem04", "Gems", OverlayTypeFlag.Gems);
        ...
        public static readonly OverlayType V17 = new OverlayType(18, "v17", "TEXT_STRUCTURE_TITLE_CIV16", new [] { TheaterTypes.Temperate, TheaterTypes.Snow });
        public static readonly OverlayType V18 = new OverlayType(19, "v18", "TEXT_STRUCTURE_TITLE_CIV17", new [] { TheaterTypes.Temperate, TheaterTypes.Snow });
        public static readonly OverlayType FlagSpot = new OverlayType(20, "fpls", "TEXT_CF_ONHOVER_SPOT", OverlayTypeFlag.Flag);
        public static readonly OverlayType WoodCrate = new OverlayType(21, "wcrate", "Wooden Crate", OverlayTypeFlag.Crate);
        public static readonly OverlayType SteelCrate = new OverlayType(22, "scrate", "Steel Crate", OverlayTypeFlag.Crate);
        public static readonly OverlayType Fence = new OverlayType(23, "fenc", "TEXT_STRUCTURE_RA_FENC", OverlayTypeFlag.Wall);
        public static readonly OverlayType WaterCrate = new OverlayType(24, "wwcrate", "Water Crate", OverlayTypeFlag.Crate);
