...
namespace MobiusEditor.RedAlert
{
    ...
    {
        public static readonly InfantryType E1 = new InfantryType(0, "e1", "TEXT_UNIT_RA_E1", "Greece", UnitTypeFlag.IsArmed);
        public static readonly InfantryType E2 = new InfantryType(1, "e2", "TEXT_UNIT_RA_E2", "USSR", UnitTypeFlag.IsArmed);
        public static readonly InfantryType E3 = new InfantryType(2, "e3", "TEXT_UNIT_RA_E3", "Greece", UnitTypeFlag.IsArmed);
        public static readonly InfantryType E4 = new InfantryType(3, "e4", "TEXT_UNIT_RA_E4", "USSR", UnitTypeFlag.IsArmed);
        public static readonly InfantryType E6 = new InfantryType(4, "e6", "TEXT_UNIT_RA_E6", "USSR");
        public static readonly InfantryType E7 = new InfantryType(5, "e7", "TEXT_UNIT_RA_E7", "Greece", UnitTypeFlag.IsArmed);
