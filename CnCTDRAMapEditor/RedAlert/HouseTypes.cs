...
namespace MobiusEditor.RedAlert
{
    public static class HouseTypes
    {
        ...
        public static readonly HouseType Multi3 = new HouseType(14, "Multi3", HouseTypeFlag.ForAlliances, "MULTI3"); // red
        public static readonly HouseType Multi4 = new HouseType(15, "Multi4", HouseTypeFlag.ForAlliances, "MULTI4"); // green
        public static readonly HouseType Multi5 = new HouseType(16, "Multi5", HouseTypeFlag.ForAlliances, "MULTI5"); // orange
        public static readonly HouseType Multi6 = new HouseType(17, "Multi6", HouseTypeFlag.ForAlliances, "MULTI7"); // purple; fixed to match actual game.
        public static readonly HouseType Multi7 = new HouseType(18, "Multi7", HouseTypeFlag.ForAlliances, "MULTI6"); // blue; fixed to match actual game.
        public static readonly HouseType Multi8 = new HouseType(19, "Multi8", HouseTypeFlag.ForAlliances, "MULTI8"); // pink
